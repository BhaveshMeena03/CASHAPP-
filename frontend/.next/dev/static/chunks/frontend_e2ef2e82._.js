...
async function fetchInstruments() {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/investing/instruments');
    return res.data.data?.instruments || [];
}
async function fetchQuote(symbol, timeRange) {
    const params = timeRange ? `?timeRange=${timeRange}` : '';
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/investing/quote/${symbol}${params}`);
    return res.data.data || {};
}
async function fetchPositions() {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/investing/positions');
    return res.data.data || {
        positions: [],
        totalValue: 0
    };
...
async function placeOrder({ symbol, side, amountCents }) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/investing/orders', {
        symbol,
        side,
        amountCents
    });
...
async function fetchOrders(symbol) {
    ...
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/investing/orders${params}`);
...
function StocksPage() {
    ...
    const [stocksWithPrices, setStocksWithPrices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [totalValue, setTotalValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const loadData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StocksPage.useCallback[loadData]": async ()=>{
            try {
                // Fetch instruments (filter out BTC — stocks only)
                const allInstruments = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$assets$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchInstruments"])();
                const stocks = allInstruments.filter({
                    "StocksPage.useCallback[loadData].stocks": (i)=>i.type === 'equity'
                }["StocksPage.useCallback[loadData].stocks"]);
                setInstruments(stocks);
                // Fetch quotes for each stock
                const withPrices = await Promise.all(stocks.map({
                    "StocksPage.useCallback[loadData]": async (stock)=>{
                        try {
                            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$assets$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchQuote"])(stock.symbol, '1D');
                            return {
                                ...stock,
                ...
                }["StocksPage.useCallback[loadData]"]));
                setStocksWithPrices(withPrices);
                // Fetch portfolio
                const portfolio = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$assets$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchPositions"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            portfolioValue > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "px-6 mb-6",
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            holding && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(StocksPage, "M6jVZ51v9O2zZL9UBmuqcwUQHC8=", false, function() {
    return [
...
//# sourceMappingURL=frontend_e2ef2e82._.js.map