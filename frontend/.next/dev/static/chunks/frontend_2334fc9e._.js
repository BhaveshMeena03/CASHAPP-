...
"[project]/frontend/app/crypto/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CryptoPage() {
    ...
    const [cryptoData, setCryptoData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
                ...
                "CryptoPage.useEffect.fetchCryptos": async ()=>{
                    ...
                    try {
                        ...
                        const [posRes, cashRes] = await Promise.all([
                            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/trading/positions?asset_class=crypto"),
                        ...
                        const posMap = {};
                        posData.forEach({
                            "CryptoPage.useEffect.fetchCryptos": (p)=>{
                                posMap[p.symbol] = p;
                            }
                        }["CryptoPage.useEffect.fetchCryptos"]);
                        setPositions(posMap);
                        // Fetch latest bars (fallback for crypto summary quotes)
                        const fetchPromises = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$assets$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CRYPTOS"].map({
                            "CryptoPage.useEffect.fetchCryptos.fetchPromises": async (crypto)=>{
                                try {
                                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/trading/crypto/bars/${crypto.symbol}?timeframe=1Day&limit=2`);
                        ...
                        }["CryptoPage.useEffect.fetchCryptos.fetchPromises"]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    dataLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        className: "space-y-3",
                        children: cryptoData.map((crypto)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(CryptoPage, "+vYbq1InIEiMEBBNaIHp4UBgZVg=", false, function() {
    return [
...
//# sourceMappingURL=frontend_2334fc9e._.js.map